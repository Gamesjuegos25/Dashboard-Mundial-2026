...
const STADIUM_INFO: Record<string, { descripcion: string; capacidad: number; inaugurado: number; superficie: string }> = {
  ...
  "Estadio de Houston": { capacidad: 72220, inaugurado: 2002, superficie: "Césped natural", descripcion: "Conocido como NRG Stadium, es el hogar de los Houston Texans de la NFL. Fue el primer estadio de la NFL con techo retráctil. Houston es una de las ciudades más diversas de EE.UU., con una gran comunidad latina." },
...
const COUNTRY_INFO: Record<string, { nombre: string; capital: string; poblacion: string; area: string; idioma: string; moneda: string; region: string; zonaHoraria: string; descripcion: string; flag: string }> = {
  ...
  IT: { nombre: "Italia", capital: "Roma", poblacion: "59 millones", area: "301,340 km²", idioma: "Italiano", moneda: "Euro (EUR)", region: "Europa", zonaHoraria: "UTC+1", flag: "it", descripcion: "Italia es tetracampeona del mundo (1934, 1938, 1982, 2006) y campeona de Europa en 2020. Es conocida mundialmente por su arte, arquitectura, gastronomía y moda. Roma, Milán y Venecia son íconos culturales universales." },
  ...
  IR: { nombre: "Irán", capital: "Teherán", poblacion: "87 millones", area: "1,648,195 km²", idioma: "Persa", moneda: "Rial iraní (IRR)", region: "Asia Occidental", zonaHoraria: "UTC+3:30", flag: "ir", descripcion: "Irán es una de las civilizaciones más antiguas del mundo. Conocida antiguamente como Persia, tiene una herencia cultural extraordinaria. Es el cuarto clasificador más consistente de Asia al Mundial." },
